...
const float PID_Left_Param[3] = {43.76784258886434, 31.05868896893543, 0.0};
// opsi lain  {1.38557049967, 7.54756237546, 0.0}; {10.841590547935285, 10.792267519067021, 0.0}; {5.262405946029307, 5.2633521364463975, 0.0};
const float PID_Right_Param[3] = {67.45904568848835, 41.82036305808888, 0.0};
// opsi lain  {1.458276247025, 3.636410241146, 0.0}; {24.059253552118907, 29.846972490602386, 0.0}; {4.792860136052465, 7.504651405649379, 0.0};
...
void motor_setup(){
  ...
  PIDLeftMotor.SetOutputLimits(-max_speed, max_speed);
  PIDRightMotor.SetOutputLimits(-max_speed, max_speed);
}
